export function AboutMe() {
  return (
    <div className="bg-white flex flex-col gap-4 p-6 rounded-xl w-fit max-w-3xl border-l-8 border-orange-500 shadow-md m-2 opacity-0 animate-fadeIn [animation-delay:300ms] mx-auto">
